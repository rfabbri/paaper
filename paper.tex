...
July 2011 git repositories and online wiki, that we have used this powerful concept in AA independently of any major mass midia incident. Moreover, screencasting differs
...
become publically aggregated on a Website called pAAnel. It is then possible for a manager or another
...
methodology. The proposed methodology was applyed to a group of 9 developers in
...
responsibility was that of using AA for at least one sesssion of 2h per day,
...
individuals and labMacambira.sf.net team as a whole. The various newcommers
benefitted from a fast learning team by the use of AA as a flexible and simple
...
Authors acknowledge the financial support from Pontao Nos Digitais, and
